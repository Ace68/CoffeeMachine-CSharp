...
namespace CoffeeMachine.Test
{
    public class DrinkMakerTest
    {
        ...
        {
            var coffeeMachine = new CoffeeMachineTest();
        }
        ...
        public void Should_Translate_CommandPocoInto_String(string drinkType, int sugarQuantity, double money,bool isCold,  string expected)
        {
            ...
            var drinkMakerCommand = coffeeMachine.GetDrinkMakerCommand(userCommand);
        ...
        {
            var coffeMachine = new CoffeeMachineTest();

            var test1 = GenerateTestCommand("Coffee", 1, 1.0, false);

            coffeMachine.GetDrinkMakerCommand(test1);
